...
docker exec -it influxdb influx auth create -o MY_PROYECT --read-buckets 4d6a72e1d14b6d88 --read-dashboards --read-tasks --read-telegrafs 0802bdb04b324000 --read-user
